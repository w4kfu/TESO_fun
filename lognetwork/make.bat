...
@link main.obj dbg.obj hookstuff.obj lib/LDE64.lib /dll /release /subsystem:console /SUBSYSTEM:console,5.01 /OSVERSION:5.1 /out:lognetwork.dll /MACHINE:IX86 /BASE:0x400000 /MANIFEST:NO  /merge:.rdata=.text /DYNAMICBASE:NO
